...
students = [
  { sid: 1, name: "Sangeetha", hasMentor: false },
  { sid: 2, name: "Maghilan", hasMentor: true, tid: 1 },
  { sid: 3, name: "Kishore", hasMentor: true, tid: 2 },
  { sid: 4, name: "Karthika", hasMentor: false },
  { sid: 5, name: "Ragavi", hasMentor: true, tid: 1 },
  { sid: 6, name: "Hema", hasMentor: false },
];
mentors = [
  { tid: 1, name: "Roshini", studentids: [2, 5] },
  { tid: 2, name: "Monisha", studentids: [3] },
];
